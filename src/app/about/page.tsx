    ...
    <article className="max-w-3xl mx-auto">
      ...
      <section className="mt-12 p-6 bg-gray-50 dark:bg-gray-900 rounded-lg">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="font-semibold text-lg mb-2">Building</h3>
            <p className="text-gray-600 dark:text-gray-400">
              Personal website with AI-powered content tools. Exploring how to combine
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Deep-diving into AI agent architectures, evaluation frameworks, and
              production deployment patterns. Reading papers on tool use and multi-step reasoning.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mt-12">
        ...
        <div className="flex gap-4">
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 bg-gray-900 dark:bg-gray-100
